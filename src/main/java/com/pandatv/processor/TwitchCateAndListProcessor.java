...
//                }
    ...
    public static void crawler(String[] args) {
        ...
        Spider.create(new TwitchCateAndListProcessor()).thread(25).addUrl(firstUrl).addPipeline(new ConsolePipeline()).setDownloader(new PandaDownloader()).setScheduler(new PriorityScheduler()).run();
