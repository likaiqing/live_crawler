...
#mv /data/tmp/crawler/log/$task.log /data/tmp/crawler/log/$task_${date}_${hour}_${minute}.log
#rm /data/tmp/crawler/${task}_${3_day_ago}_${hour}_${minute}.csv /data/tmp/crawler/log/$task_${3_day_ago}_${hour}_${minute}.log
