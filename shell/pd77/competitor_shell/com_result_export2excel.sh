...
/usr/local/jdk1.8.0_60/bin/java -jar $mailjar "竞品分析:$date" "报表见附件" $zip_dir/competitor_report_${date}.zip "fengwenbo@panda.tv" "baimuhai@panda.tv,lushenggang@panda.tv,likaiqing@panda.tv,zhaolirong@panda.tv"
